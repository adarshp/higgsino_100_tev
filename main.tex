...
\abstract{% 
  ...
  for discovering pair-produced Higgsino-like next-to-lightest supersymmetric particles (NLSP)  at a 100 TeV 
  hadron collider that decay to Bino-like lightest supersymmetric particle (LSP) via intermediate $Z$ and 
  SM Higgs bosons that in turn decay to a pair of leptons and a pair of 
  $b$-quarks respectively: $\N_{2}\N_{3}
  \rightarrow (Z\N_1)(h\N_1)\rightarrow 
  bb\ell\ell+\N_1\N_1$. In addition, we examine 
  ...
  to 1.3 TeV at 95\% C.L.   This search channel extends the multi-lepton search limits, especially in the region where the mass difference between
Higgsino NLSP and Bino LSP is smaller. \Shufang{Update the numbers.}
}
...
\begin{table}[h]
  ...
  \caption{Representative cut flow table for the benchmark point $\mu=1$ TeV,
    ...
    calculated for an integrated luminosity of 3 ab$^{-1}$.   \Shufang{MET $>$ 400 or $<$ 400? }}
