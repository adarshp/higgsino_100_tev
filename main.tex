...
\begin{figure}[h]
  ...
  \caption{Higgsino pair production $\N_2\N_3$
    ...
    on $M_1$ is very weak.  \Shufang{Could you use $\mu$ for both xlabels?  The
    CS and Br will depend slightly on the sign of mu.  Since we do use positive
  mu in our analyses, let's label it this way.  I have a footnote in intro to
explain the sign effect of mu.  Also, change right panel, ylabel to be either
Br or Branching Fraction.}
}
