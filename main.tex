...
unweighted) left over after cuts\footnote{\ap{This is inspired by the upper
    ...
    discovery reach of our analysis showed a steady increase. This, combined with the
    fact that we were pushing the limits of our storage and computing capacity
    (we generated $\approx 14$ million $tt$ events and $\approx
    850$K $tbW$ events - both unweighted), lead us to believe that the projected reaches
presented in this paper are conservative ones.}}. We can see that, after
applying our cuts, $tbW$ remains as the dominant backgrounds, followed by $tt$.
The values of the razor variable cuts were chosen to maximize the significance,
