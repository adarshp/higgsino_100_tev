...
\abstract{% 
  ...
  (LSP) via intermediate $Z$ and SM Higgs boson that in turn decay to a pair
  ...
  Using this analysis, Higgsinos up to 1.4 TeV can be discovered  at 5 $\sigma$ level for a Bino with
  mass of about
  0.9 TeV using 3000 fb$^{-1}$ of data.  Additionally, Higgsinos up to 1.8
  TeV can be excluded  at 95\% C.L. for a Bino with mass of about 1.4 TeV。   This search
  channel extends the multi-lepton search limits, especially in the region
  where the mass difference between the Higgsino NLSPs and the Bino LSP is small.
}
